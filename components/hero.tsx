    ...
    return (
        ...
        to-tertiary bg-clip-text text-transparent"
                        ...
                        <motion.p
                            ...
                            className="text-xl mb-2 bg-gradient-to-r from-primary via-secondary
        to-tertiary bg-clip-text text-transparent mt-0"
                        >
                            Computer Science Student | Digital Marketer | Tech Enthusiast
                        ...
                        >
                            ...
                            Tech-savvy Computer Science student with a Diploma background, skilled in digital marketing, SEO, MS Office, data entry, Canva design, and basic hardware and networking support.
